...
```
has a rather flat representation. Note that the _even_ objects  (_unsigned(31 downto 0)_ and _rows_) are stacked horizontally, and the _odd_ objects (_cols_) vertically.  

![3 * (3 * (3 objects))](./stacked_1D-hor.png)
